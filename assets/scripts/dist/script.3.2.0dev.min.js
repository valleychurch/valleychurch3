...
!function(e, t, n) {
    ...
    function o() {
        ...
        for (var l in C) if (C.hasOwnProperty(l)) {
            ...
            s = a.split("."), 1 === s.length ? Modernizr[s[0]] = o : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), 
            Modernizr[s[0]][s[1]] = o), x.push((o ? "" : "no-") + s.join("-"));
        }
    }
    function i(e) {
    ...
    function a(e, t) {
        if ("object" == typeof e) for (var n in e) _(e, n) && a(n, e[n]); else {
            e = e.toLowerCase();
            ...
            Modernizr[r[0]][r[1]] = t), i([ (t && 0 != t ? "" : "no-") + r.join("-") ]), Modernizr._trigger(e, t);
        }
        return Modernizr;
    }
    function s() {
    ...
    function u(e, n, r, o) {
        var i, a, u, f, c = "modernizr", d = s("div"), p = l();
        ...
        w.style.overflow = "hidden", w.appendChild(p)), a = n(d, e), p.fake ? (p.parentNode.removeChild(p), 
        w.style.overflow = f, w.offsetHeight) : d.parentNode.removeChild(d), !!a;
    }
    function f(e) {
    ...
    function g(e, t, o, i) {
        ...
        for (var u, d, p, m, g, v = [ "modernizr", "tspan" ]; !L.style; ) u = !0, L.modElem = s(v.shift()), 
        L.style = L.modElem.style;
        for (p = e.length, d = 0; p > d; d++) if (m = e[d], g = L.style[m], c(m, "-") && (m = f(m)), 
        L.style[m] !== n) {
    ...
    function v(e, t, n, o, i) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(s, t, o, i) : (s = (e + " " + F.join(a + " ") + a).split(" "), 
        p(s, t, n));
    }
    function y(e, t, r) {
        return v(e, n, n, t, r);
    ...
    Modernizr.prototype = S, Modernizr = new Modernizr(), Modernizr.addTest("geolocation", "geolocation" in navigator), 
    Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
    var w = t.documentElement, b = "svg" === w.nodeName.toLowerCase();
    b || !function(e, t) {
        function n(e, t) {
        ...
        function u(e) {
            e || (e = t);
            var r = i(e);
            return !x.shivCSS || f || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), 
            c || l(e, r), e;
        }
    ...
    S.mq = j;
    var N = S.testStyles = u, z = "Moz O ms Webkit", P = S._config.usePrefixes ? z.split(" ") : [];
    S._cssomPrefixes = P;
    var k = function(t) {
        var r, o = D.length, i = e.CSSRule;
        if ("undefined" == typeof i) return n;
        if (!t) return !1;
        if (t = t.replace(/^@/, ""), r = t.replace(/-/g, "_").toUpperCase() + "_RULE", r in i) return "@" + t;
        for (var a = 0; o > a; a++) {
            var s = D[a], l = s.toUpperCase() + "_" + r;
    ...
    Modernizr._q.unshift(function() {
        delete L.style;
    }), S.testAllProps = v, S.testAllProps = y, Modernizr.addTest("flexbox", y("flexBasis", "1px", !0)), 
    ...
    var D = S._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    S._prefixes = D, Modernizr.addTest("csscalc", function() {
        var e = "width:", t = "calc(10px);", n = s("a");
        return n.style.cssText = e + D.join(t + e), !!n.style.length;
    }), o(), i(x), delete S.addTest, delete S.addAsyncTest;
    ...
    function getAllSourceElements(picture, candidates) {
        ...
        for (i = 0, len = sources.length; len > i; i++) source = sources[i], source[pf.ns] = !0, 
    ...
    var warn, eminpx, alwaysCheckWDescriptor, evalId, pf = {}, isSupportTestReady = !1, noop = function() {}, image = document.createElement("img"), getImgAttr = image.getAttribute, setImgAttr = image.setAttribute, removeImgAttr = image.removeAttribute, docElem = document.documentElement, types = {}, cfg = {
        algorithm: ""
        ...
        if (isSupportTestReady) {
            ...
            plen = elements.length) {
                for (pf.setupRun(options), alreadyRun = !0, i = 0; plen > i; i++) pf.fillImg(elements[i], options);
    ...
    }(document.createElement("img")), pf.supSrcset && !pf.supSizes ? !function() {
        var width2 = "data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==", width1 = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", img = document.createElement("img"), test = function() {
            var width = img.width;
            2 === width && (pf.supSizes = !0), alwaysCheckWDescriptor = pf.supSrcset && !pf.supSizes, 
            isSupportTestReady = !0, setTimeout(picturefill);
        };
        img.onload = test, img.onerror = test, img.setAttribute("sizes", "9px"), img.srcset = width1 + " 1w," + width2 + " 9w", 
        img.src = width1;
    }() : isSupportTestReady = !0, pf.selShort = "picture>img,img[srcset]", pf.sel = pf.selShort, 
    pf.cfg = cfg, pf.DPR = DPR || 1, pf.u = units, pf.types = types, pf.setSize = noop, 
    pf.makeUrl = memoize(function(src) {
        ...
        imageSet.cands.push({
            ...
            sizes: null
        }), imageData.curCan = null, imageData.curSrc = undefined, imageData.supported = !(hasPicture || imageSet && !pf.supSrcset || isWDescripor && !pf.supSizes), 
        ...
        var isDomReady, regReady = window.attachEvent ? /d$|^c/ : /d$|^c|^i/, run = function() {
            ...
            var timeout, timestamp, later = function() {
                ...
                wait > last ? timeout = setTimeout(later, wait - last) : (timeout = null, func());
            };
            return function() {
...
}(window, document), function(w, o, undefined) {
    o === undefined && (w.overthrow = o = {}), o.easing = function(t, b, c, d) {
        return c * ((t = t / d - 1) * t * t + 1) + b;
    };
    var raf = function() {
        return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(callback) {
            w.setTimeout(callback, 1e3 / 60);
        };
    }(), tossingElems = {};
    o.tossing = function(elem, state) {
        return state !== undefined && (tossingElems[elem] = state), tossingElems[elem];
    };
    o.toss = function(elem, options) {
        o.tossing(elem, !1);
        var endLeft, endTop, i = 0, sLeft = elem.scrollLeft, sTop = elem.scrollTop, op = {
            top: "+0",
            left: "+0",
            duration: 200,
            easing: o.easing,
        ...
        "string" == typeof op.left ? (op.left = parseFloat(op.left), endLeft = op.left + sLeft) : (endLeft = op.left, 
        op.left = op.left - sLeft), "string" == typeof op.top ? (op.top = parseFloat(op.top), 
        endTop = op.top + sTop) : (endTop = op.top, op.top = op.top - sTop), o.tossing(elem, !0);
        var startTime = new Date().getTime(), endTime = startTime + op.duration, run = function() {
            var curTime = new Date().getTime();
            if (o.tossing(elem)) {
                if (endTime > curTime) return i = (curTime - startTime) / op.duration * op.duration, 
                elem.scrollLeft = op.easing(i, sLeft, op.left, op.duration), elem.scrollTop = op.easing(i, sTop, op.top, op.duration), 
                raf(run);
                elem.scrollLeft = endLeft, elem.scrollTop = endTop, op.finished && op.finished(), 
                o.tossing(elem, !1);
            } else op.finished && op.finished();
        };
        return raf(run), {
            top: endTop,
            left: endLeft,
        ...
        elem && o.tossing(elem, !1);
    };
}(this, this.overthrow), function(w, $) {
    var pluginName = "snapper";
    $.fn[pluginName] = function() {
        function itemsAtOffset(elem, offset) {
            var $childNodes = $(elem).find("." + pluginName + "_item"), containWidth = $(elem).width(), activeItems = [];
            return $childNodes.each(function(i) {
                this.offsetLeft >= offset - 5 && this.offsetLeft < offset + containWidth - 5 && activeItems.push(this);
            }), $(activeItems);
        }
        ...
        function snapEvent(elem, x) {
            ...
            $(elem).trigger(pluginName + ".snap", {
                activeSlides: activeSlides
            });
        }
        function goto(elem, x, nothrow) {
            snapEvent(elem, x), "undefined" == typeof w.overthrow || nothrow ? elem.scrollLeft = x : w.overthrow.toss(elem, {
                left: x
            });
        }
        var testProp = "scroll-snap-type", snapSupported = w.CSS && w.CSS.supports && (w.CSS.supports(testProp, "mandatory") || w.CSS.supports("-webkit-" + testProp, "mandatory") || w.CSS.supports("-ms-" + testProp, "mandatory"));
        return this.each(function() {
            function updateWidths() {
                ...
                var sliderWidth = $slider.width(), itemWidth = $items.eq(0).width(), computed = w.getComputedStyle($items[0], null), itemLeftMargin = parseFloat(computed.getPropertyValue("margin-left")), itemRightMargin = parseFloat(computed.getPropertyValue("margin-right"));
                $items.eq(0).attr("style", itemStyle), $itemsContain.attr("style", itemsContainStyle);
                var iPercentWidth = itemWidth / sliderWidth * 100, iPercentRightMargin = itemRightMargin / sliderWidth * 100, iPercentLeftMargin = itemLeftMargin / sliderWidth * 100, outerPercentWidth = iPercentWidth + iPercentLeftMargin + iPercentRightMargin, percentAsWidth = iPercentWidth / outerPercentWidth, percentAsRightMargin = iPercentRightMargin / outerPercentWidth, percentAsLeftMargin = iPercentLeftMargin / outerPercentWidth;
                $itemsContain.css("width", Math.ceil(numItems * outerPercentWidth) + "%"), $items.css("width", 100 / numItems * percentAsWidth + "%"), 
                $items.css("margin-left", 100 / numItems * percentAsLeftMargin + "%"), $items.css("margin-right", 100 / numItems * percentAsRightMargin + "%");
            }
            function snapScroll() {
                var currScroll = $slider[0].scrollLeft, width = $itemsContain.width(), itemWidth = $items[1] ? $items[1].offsetLeft : outerWidth($items.eq(0)), roundedScroll = Math.round(currScroll / itemWidth) * itemWidth, maxScroll = width - $slider.width();
                roundedScroll > maxScroll && (roundedScroll = maxScroll), currScroll !== roundedScroll && (snapSupported ? snapEvent($slider[0], roundedScroll) : goto($slider[0], roundedScroll));
            }
            function snapStay() {
                var currScroll = $slider[0].scrollLeft, numItems = $items.length, width = $itemsContain.width();
                void 0 === startSlide && (startSlide = Math.round(currScroll / width * numItems)), 
                afterResize && clearTimeout(afterResize), afterResize = setTimeout(function() {
                    updateWidths(), goto($slider[0], $items[startSlide].offsetLeft, !0), startSlide = afterResize = void 0;
                }, 50);
            }
            function arrowNavigate(forward) {
                var currScroll = $slider[0].scrollLeft, width = $itemsContain.width(), itemWidth = outerWidth($slider), maxScroll = width - itemWidth - 5;
                return forward ? currScroll >= maxScroll ? first() : next() : 0 === currScroll ? last() : prev();
            }
            function next() {
            ...
            function activeItem() {
                var currScroll = $slider[0].scrollLeft, width = outerWidth($itemsContain), activeIndex = Math.round(currScroll / width * numItems);
                $nav.children().removeClass(navSelectedClass).eq(activeIndex).addClass(navSelectedClass);
            }
            var self = this, addNextPrev = $(self).is("[data-" + pluginName + "-nextprev]"), $slider = $("." + pluginName + "_pane", self), enhancedClass = pluginName + "-enhanced", $itemsContain = $slider.find("." + pluginName + "_items"), $items = $itemsContain.children();
            $items.addClass(pluginName + "_item");
            var numItems = $items.length, $nav = $("." + pluginName + "_nav", self), navSelectedClass = pluginName + "_nav_item-selected";
            if (updateWidths(), $(self).addClass(enhancedClass), addNextPrev) {
                var $nextprev = $('<ul class="snapper_nextprev"><li class="snapper_nextprev_item"><a href="#prev" class="snapper_nextprev_prev">Prev</a></li><li class="snapper_nextprev_item"><a href="#next" class="snapper_nextprev_next">Next</a></li></ul>'), $nextprevContain = $(".snapper_nextprev_contain", self);
                $nextprevContain.length || ($nextprevContain = $(self)), $nextprev.appendTo($nextprevContain);
            }
            $("a", this).bind("click", function(e) {
                var slideID = $(this).attr("href");
                if (-1 !== slideID.indexOf("#")) {
                    if (e.preventDefault(), $(this).is(".snapper_nextprev_next")) return arrowNavigate(!0);
                    if ($(this).is(".snapper_nextprev_prev")) return arrowNavigate(!1);
                    var $slide = $(slideID, self);
                    goto($slider[0], $slide[0].offsetLeft), "replaceState" in w.history && w.history.replaceState({}, document.title, slideID);
                }
            }), $(this).attr("tabindex", "0").bind("keyup", function(e) {
                (37 === e.keyCode || 38 === e.keyCode) && (e.preventDefault(), arrowNavigate(!1)), 
                (39 === e.keyCode || 40 === e.keyCode) && (e.preventDefault(), arrowNavigate(!0));
            });
            var startSlide, afterResize;
            $(w).bind("resize", snapStay), $nav.length && ($slider.bind("scroll", activeItem), 
            activeItem());
            var scrollStop;
            $slider.bind("scroll", function(e) {
                scrollStop && clearTimeout(scrollStop), scrollStop = setTimeout(snapScroll, 50);
            });
        });
...
var Valley = function() {
    var doc = document, win = window, nav = navigator, $doc = $(doc), $win = $(win), $body = $("body"), $header = $(".c-header");
    return {
        Version: "3.2.0dev",
        Init: function() {
            doc.documentElement.setAttribute("data-useragent", nav.userAgent), $doc.trigger("enhance"), 
            Valley.InitSideNav(), Valley.ModernizrTest(), Valley.Slider(), Valley.CheckNotifications(), 
            Valley.ResponsiveIframes(), Valley.DownArrows(), Valley.CheckHeaderPosition(), Valley.SetMainLocation(), 
            Valley.RemoveMainLocation(), Valley.CheckMainLocation();
        },
        InitMap: function(map_centre, zoom, auto_size, location_array, info_window_content, marker_click, scrollable) {
            if (googleActive === !0) {
                mapCentre = map_centre, mapOpts = {
                    zoom: zoom,
                    center: map_centre,
                    rotateControl: !1,
                    panControl: !1,
                ...
                map.set("styles", mapStyle), "" !== info_window_content && (mapInfoWindow = new google.maps.InfoWindow({
                    content: "Loading..."
                })), 1 === auto_size && (mapBounds = new google.maps.LatLngBounds()), mapLocations = location_array;
                for (var i = 0; i < mapLocations.length; i++) {
                    ...
                    }), "" !== info_window_content && google.maps.event.addListener(mapMarker, "click", function() {
                        mapInfoWindow.setContent(info_window_content), mapInfoWindow.open(map, this);
                    }), 1 === marker_click && google.maps.event.addListener(mapMarker, "click", function() {
                        win.location.href = this.url;
                    }), 1 === auto_size && mapBounds.extend(new google.maps.LatLng(mapLoc[0], mapLoc[1]));
                }
                1 === auto_size && map.fitBounds(mapBounds), Valley.CentreMap(auto_size), google.maps.event.addDomListener(win, "resize", Valley.CentreMap(auto_size));
            }
        },
        CentreMap: function(auto_size) {
            google.maps.event.trigger(map, "resize"), map.setCenter(mapCentre), 1 === auto_size && map.fitBounds(mapBounds);
        },
        CheckNotifications: function() {
            try {
                var notificationData = JSON.parse(localStorage.getItem("Valley.Notification"));
                null !== notificationData ? $(".c-notification").data("notification-id") !== notificationData.id && (localStorage.removeItem("Valley.Notification"), 
                Valley.AttachNotifications()) : Valley.AttachNotifications();
            } catch (e) {
                console.log("Error: " + e.message);
            }
        },
        AttachNotifications: function() {
            $(".c-notification").addClass("is-notification-active").attr("aria-expanded", "true"), 
            $(".js-notification-dismiss").on("click", function(e) {
                e.preventDefault(), $(".c-notification").attr("aria-expanded", "false").removeClass("is-notification-active");
        ...
        ModernizrTest: function() {
            Modernizr.addTest("fontvariant", function() {
                var fontVariantLigatures = !!("fontVariantLigatures" in doc.body.style), fontFeatureSettings = !!("fontFeatureSettings" in doc.body.style);
                return !(!fontVariantLigatures && !fontFeatureSettings);
            });
        },
        Slider: function() {
            var prevImg = '<img src="//cdn.valleychurch.eu/wp-content/themes/valleychurch3/assets/images/dist/icon-prev.svg" width="100%" height="100%" class="prev-btn" />', nextImg = '<img src="//cdn.valleychurch.eu/wp-content/themes/valleychurch3/assets/images/dist/icon-next.svg" width="100%" height="100%" class="next-btn" />';
        ...
        InitSideNav: function() {
            $(".js-nav-toggle").on("click", function(e) {
                e.preventDefault(), $body.toggleClass("is-menu-active");
            });
        },
        CheckSideNav: function() {
            Modernizr.mq("(min-width: 60em)") && $body.hasClass("is-menu-active") && $body.removeClass("is-menu-active");
        },
        ...
        CheckHeaderPosition: function() {
            ...
            $body.hasClass("home") && (scroll > 150 && !$header.hasClass("is-visible") && $header.addClass("is-visible"), 
            150 > scroll && $header.hasClass("is-visible") && $header.removeClass("is-visible"));
        },
        SetMainLocation: function() {
            $(".js-set-location").on("click", function(e) {
                e.preventDefault();
                var id = $(this).data("location-id"), name = $(this).data("location-name"), locationData = {
                    id: id,
                    name: name
                };
                localStorage.setItem("Valley.Location", JSON.stringify(locationData)), $(this).removeClass("js-set-location").addClass("js-remove-location").text("Remove as my main location"), 
                Valley.RemoveMainLocation();
            });
        },
        RemoveMainLocation: function() {
            $(".js-remove-location").on("click", function(e) {
                e.preventDefault(), localStorage.removeItem("Valley.Location"), $(this).removeClass("js-remove-location").addClass("js-set-location").text("Set as my main location"), 
                Valley.SetMainLocation();
            });
        },
        CheckMainLocation: function() {
            try {
                var locationData = JSON.parse(localStorage.getItem("Valley.Location")), $hiddenlocation = $('input[name="mylocation"]');
                if (0 !== $(".js-set-location").length) {
                    var $this = $(".js-set-location"), id = $this.data("location-id"), name = $this.data("location-name");
                    null !== locationData && locationData.id === id && locationData.name === name && ($this.removeClass("js-set-location").addClass("js-remove-location").text("Remove as my main location"), 
                    Valley.RemoveMainLocation());
                }
                0 !== $hiddenlocation.length && null !== locationData && $hiddenlocation.val(locationData.id);
            } catch (e) {
                console.log("Error: " + e.message);
            }
        }
