...
<?php } ?>
<img src="<?= $img_large[0]; ?>" srcset="<?= $img_medium[0]; ?> 640w, <?= $img_large[0]; ?> 1280w, <?= $img[0]; ?> 2000w" alt="<?php the_title(); ?>" class="<?= get_query_var( 'class', 'c-section__img' ); ?> <?= ( get_query_var( 'margin' ) === true ) ? "u-margin" : ""; ?>">
<?php if ( get_query_var( 'figure' ) === true ) { ?>
</figure>
<?php } ?>
